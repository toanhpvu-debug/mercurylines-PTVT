...
"=== kiem thu ==="
$bo = @("kiem-tra-ngon-ngu","kiem-tra-ma-vat-tu","kiem-tra-phan-quyen","kiem-tra-mau-danh-muc","kiem-tra-dong-bo","kiem-tra-doc-phieu","kiem-tra-bieu-mau-db","thu-xuat-kiem-ke","kiem-tra-qr")
foreach ($s in $bo) {
