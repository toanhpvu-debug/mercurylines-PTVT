...
"=== kiem thu ==="
$bo = @("kiem-tra-ngon-ngu","kiem-tra-ma-vat-tu","kiem-tra-phan-quyen","kiem-tra-mau-danh-muc","kiem-tra-dong-bo","kiem-tra-doc-phieu","kiem-tra-bieu-mau-db","thu-xuat-kiem-ke","kiem-tra-qr","kiem-tra-doc-phieu-giao","kiem-tra-pdf-giao","kiem-tra-doc-ai")
foreach ($s in $bo) {
