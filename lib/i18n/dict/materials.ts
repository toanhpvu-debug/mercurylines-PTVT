...
export const materials = tuDien(
  {
    ...
    // Chọn hàng loạt (ô tick từng dòng / cả bộ phận / tất cả — ChonHangLoat)
    chonDong: "Chọn {ma}",
    chonTatCa: "Chọn tất cả",
    chonTatCaGoiY: "Chọn tất cả dòng đang hiển thị (bấm \"Xem tất cả\" để hiện hết trước khi chọn).",
    chonNhom: "Chọn cả bộ phận",
    daChonN: "Đã chọn {n}",
    boChon: "Bỏ chọn",
    nutYeuCauNhanh: "Yêu cầu nhanh",
    nutYeuCauNhanhLoai: "Yêu cầu {loai} ({n})",
    nutSuaHangLoat: "Sửa hàng loạt",
    xacNhanXoaHangLoat:
      "Xóa {n} mặt hàng đã chọn khỏi danh mục dùng chung? Mặt hàng đang có tồn kho hoặc đã dùng trong yêu cầu sẽ được giữ lại và báo riêng.",
    suaHangLoatTieuDe: "Sửa hàng loạt {n} mặt hàng",
    suaHangLoatMoTa: "Chỉ ô nào điền hoặc chọn mới được áp cho mọi mặt hàng đã chọn; ô để trống / \"Giữ nguyên\" thì không đụng tới. Thiết bị chỉ áp cho phụ tùng.",
    suaHangLoatThietBiGoiY: "Tick rồi gõ tên thiết bị; để trống ô = xóa thiết bị",
    giuNguyen: "— Giữ nguyên —",
    nutApDungHangLoat: "Áp dụng cho {n} mặt hàng",
    hangLoat_daXoa: "Đã xóa {n} mặt hàng.",
    hangLoat_boQua: "{n} mặt hàng được giữ lại: {ds}",
    hangLoat_daSua: "Đã cập nhật {n} mặt hàng.",
    hangLoat_khongCoGiDoi: "Chưa chọn trường nào để đổi.",
    nutXoaHangLoat: "Xóa khỏi danh mục",
    xoaChiVanPhong:
      "Xóa mặt hàng khỏi danh mục dùng chung chỉ làm được bằng tài khoản quản trị trên bản văn phòng. Bản cài trên tàu không xóa được — hãy Ngừng sử dụng hoặc Gỡ khỏi tàu.",
    xoaChiVanPhongGoiY: "Chỉ quản trị tại văn phòng. Mặt hàng có tồn kho hoặc đã dùng trong yêu cầu sẽ được giữ lại.",
    nutGoKhoiTauHangLoat: "Gỡ khỏi tàu",
    xacNhanGoKhoiTauHangLoat: "Gỡ {n} mặt hàng đã chọn khỏi danh mục của tàu này? Bản ghi dùng chung và tồn kho không bị xóa.",
    hangLoat_daGo: "Đã gỡ {n} mặt hàng khỏi tàu.",
  ...
  },
  {
    ...
    chonTatCaGoiY: "Selects all rows currently shown (click \"Show all\" first to show every row).",
    chonNhom: "Select whole department",
    daChonN: "{n} selected",
    boChon: "Clear",
    nutYeuCauNhanh: "Quick requisition",
    nutYeuCauNhanhLoai: "Requisition {loai} ({n})",
    nutSuaHangLoat: "Bulk edit",
    xacNhanXoaHangLoat:
      "Delete the {n} selected items from the shared catalogue? Items with stock or used in a requisition are kept and reported separately.",
    suaHangLoatTieuDe: "Bulk edit {n} items",
    suaHangLoatMoTa: "Only fields you fill in or choose are applied to every selected item; empty / \"Keep\" fields are left untouched. Equipment applies to spare parts only.",
    suaHangLoatThietBiGoiY: "Tick, then type the equipment; leave the box empty to clear it",
    giuNguyen: "— Keep —",
    nutApDungHangLoat: "Apply to {n} items",
    hangLoat_daXoa: "Deleted {n} items.",
    hangLoat_boQua: "{n} items were kept: {ds}",
    hangLoat_daSua: "Updated {n} items.",
    hangLoat_khongCoGiDoi: "No field chosen to change.",
    nutXoaHangLoat: "Delete from catalogue",
    xoaChiVanPhong:
      "Deleting items from the shared catalogue is only possible with an administrator account on the office installation. Ship installations cannot delete — use Deactivate or Remove from vessel instead.",
    xoaChiVanPhongGoiY: "Office administrators only. Items with stock or used in a requisition are kept.",
    nutGoKhoiTauHangLoat: "Remove from vessel",
    xacNhanGoKhoiTauHangLoat: "Remove the {n} selected items from this vessel's catalogue? The shared records and stock are not deleted.",
    hangLoat_daGo: "Removed {n} items from the vessel.",
    suaVatTu: "Edit item",
