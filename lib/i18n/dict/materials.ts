...
export const materials = tuDien(
  {
    ...
    xemVatTuToiQuanLy: "Xem mặt hàng tôi quản lý",
    ...
    themVaoDanhMucGoc: "Thêm mặt hàng (danh mục gốc)",
    vatTuCuaTau: "Vật tư & phụ tùng của {tau} ({n})",
    danhMucGocN: "Danh mục gốc ({n})",
    timNhanhGoiY: "Gõ mã, tên, IMPA, Part No., máy, hãng — lọc ngay khi gõ",
    dangHienNTrongM: "{n} / {m} dòng",
    nhayToi: "Nhảy tới",
    thuGonLai: "Thu gọn về 40 dòng đầu mỗi bộ phận",
    thuGonNhom: "Thu gọn",
    moRongNhom: "Mở rộng",
    ...
    phMaVatTu: "Mã vật tư",
    phTenVi: "Tên mặt hàng (tiếng Việt)",
    ...
    nutDungLai: "Dùng lại",
    xacNhanXoa:
      "Xóa vĩnh viễn mặt hàng {ma}? Chỉ xóa được khi chưa có tồn kho và chưa dùng trong yêu cầu nào.",
  ...
  },
  {
    ...
    themVaoDanhMucGoc: "Add item (master catalogue)",
    vatTuCuaTau: "Stores & spare parts of {tau} ({n})",
    danhMucGocN: "Master catalogue ({n})",
    timNhanhGoiY: "Type a code, name, IMPA, Part No., machine or maker — filters as you type",
    dangHienNTrongM: "{n} / {m} rows",
    nhayToi: "Jump to",
    thuGonLai: "Collapse back to the first 40 rows per department",
    thuGonNhom: "Collapse",
    moRongNhom: "Expand",
