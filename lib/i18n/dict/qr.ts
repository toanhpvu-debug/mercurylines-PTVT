...
export const qr = tuDien(
  {
    ...
    // Bảng ghi ngay trên khung quét (chế độ kiểm kê liên tục)
    dangTaiMatHang: "Đang lấy thông tin {ma}...",
    cheDoNhap: "Nhập",
    cheDoXuat: "Xuất",
    cheDoDem: "Đếm kiểm kê",
    tonTheoKho: "Tồn theo kho",
    chuaCoTonNgan: "Chưa có dòng tồn ở tàu của bạn — ghi phiếu nhập là mở thẻ kho.",
    soLuong: "Số lượng",
    soDemThucTe: "Số đếm thực tế",
    tonHeThong: "Hệ thống",
    chenhLech: "Chênh lệch",
    khop: "Khớp, không cần điều chỉnh",
    ghiChuKiemKe: "Kiểm kê: đếm {dem}, hệ thống {heThong}",
    nutGhi: "Ghi",
    nutGhiVaQuetTiep: "Ghi & quét tiếp",
    nutBoQuaQuetTiep: "Bỏ qua, quét tiếp",
    daGhi: "Đã ghi {ma}: {viec} {so} {dvt} · {kho}",
    daKhop: "{ma}: đếm khớp hệ thống ({so} {dvt}) · {kho}",
    khongGhiDuoc: "Không ghi được: {loi}",
    khongCoQuyenGhi: "Tài khoản này chỉ xem được tồn, không ghi nhập xuất.",
    phienQuet: "Phiên quét này",
    phienQuetTrong: "Chưa quét mặt hàng nào. Giơ nhãn vào khung.",
    nutXoaPhien: "Xóa danh sách",
    nutMoTheKho: "Thẻ kho",
    trungMa: "Vẫn là nhãn {ma} — đưa nhãn khác vào khung",
    coLoi: "Có lỗi xảy ra, thử lại.",
    xacNhanTieuDe: "Đồng ý ghi?",
    xacNhanNoiDung: "{viec} {so} {dvt} · {ma} · kho {kho}",
    nutDongY: "Đồng ý ghi & quét tiếp",
    nutSuaLai: "Sửa lại",
  },
  {
    ...
    dangTaiMatHang: "Loading {ma}...",
    cheDoNhap: "Receive",
    cheDoXuat: "Issue",
    cheDoDem: "Stock count",
    tonTheoKho: "Stock by warehouse",
    chuaCoTonNgan: "No stock line on your vessel yet — a receipt opens the stock card.",
    soLuong: "Quantity",
    soDemThucTe: "Counted quantity",
    tonHeThong: "System",
    chenhLech: "Difference",
    khop: "Matches, no adjustment needed",
    ghiChuKiemKe: "Stock count: counted {dem}, system {heThong}",
    nutGhi: "Save",
    nutGhiVaQuetTiep: "Save & scan next",
    nutBoQuaQuetTiep: "Skip, scan next",
    daGhi: "Saved {ma}: {viec} {so} {dvt} · {kho}",
    daKhop: "{ma}: count matches system ({so} {dvt}) · {kho}",
    khongGhiDuoc: "Could not save: {loi}",
    khongCoQuyenGhi: "This account can view stock only, not record movements.",
    phienQuet: "This scanning session",
    phienQuetTrong: "No item scanned yet. Hold a label inside the frame.",
    nutXoaPhien: "Clear list",
    nutMoTheKho: "Stock card",
    trungMa: "Still label {ma} — bring another label into the frame",
    coLoi: "Something went wrong, try again.",
    xacNhanTieuDe: "Confirm?",
    xacNhanNoiDung: "{viec} {so} {dvt} · {ma} · warehouse {kho}",
    nutDongY: "Confirm & scan next",
    nutSuaLai: "Edit",
  }
);
