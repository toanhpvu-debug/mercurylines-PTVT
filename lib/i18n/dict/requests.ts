...
export const requests = tuDien(
  {
    ...
    moi: "(mới)",
    xacNhanXoaKemDonMua:
      "Yêu cầu {ma} đang có {so} dòng nằm trong đơn mua còn hiệu lực.\n\nXóa thì đơn mua KHÔNG mất, nhưng mất đường lần về yêu cầu gốc — về sau đối chiếu sổ sẽ thấy dòng đơn mua không rõ xin từ đâu. Cách sạch hơn: hủy đơn mua trước, hoặc dùng Hủy yêu cầu để giữ lại vết.\n\nVẫn xóa?",
    nutSua: "Sửa",
    nutHuyYeuCau: "Hủy yêu cầu",
    dangHuy: "Đang hủy...",
    xacNhanHuy:
      "Hủy yêu cầu {ma}? Yêu cầu vẫn nằm trong sổ với trạng thái Đã hủy, không mất dấu.",
    suaYeuCauVatTu: "Sửa yêu cầu vật tư",
    suaYeuCauPhuTung: "Sửa yêu cầu phụ tùng",
    suaMoTa:
      "Sửa nội dung rồi lưu. Tàu và loại chứng từ không đổi được vì số yêu cầu đã mã hóa cả hai — cần khác thì xóa và lập lại.",
    luuThayDoi: "Lưu thay đổi",
    dangLuuThayDoi: "Đang lưu...",
    suaThanhCong: "Đã lưu thay đổi.",
    khongSuaDuocTieuDe: "Không sửa được yêu cầu này",
    quayLaiChiTiet: "Quay lại yêu cầu",
    nutXemIn: "Xem / In",
  ...
  },
  {
    ...
    moi: "(new)",
    xacNhanXoaKemDonMua:
      "Requisition {ma} has {so} line(s) on an active purchase order.\n\nDeleting it does NOT remove the purchase order, but the order loses its link back — later reconciliation will show order lines with no visible origin. The cleaner route: cancel the purchase order first, or cancel the requisition to keep the record.\n\nDelete anyway?",
    nutSua: "Edit",
    nutHuyYeuCau: "Cancel requisition",
    dangHuy: "Cancelling...",
    xacNhanHuy:
      "Cancel requisition {ma}? It stays in the records marked Cancelled, nothing is lost.",
    suaYeuCauVatTu: "Edit stores requisition",
    suaYeuCauPhuTung: "Edit spare parts requisition",
    suaMoTa:
      "Change the contents and save. The vessel and document type cannot change because the requisition number encodes both — delete and re-create if you need different ones.",
    luuThayDoi: "Save changes",
    dangLuuThayDoi: "Saving...",
    suaThanhCong: "Changes saved.",
    khongSuaDuocTieuDe: "This requisition cannot be edited",
    quayLaiChiTiet: "Back to requisition",
    nutXemIn: "View / Print",
