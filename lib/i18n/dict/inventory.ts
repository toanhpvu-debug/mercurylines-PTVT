...
export const inventory = tuDien(
  {
    ...
    // Sửa bản in MLS-11-01 trước khi in (BaoCaoVatTuSua)
    suaTruocKhiIn: "Sửa trước khi in",
    xongSua: "Xong sửa",
    themDongBaoCao: "Thêm dòng",
    xoaDongBaoCao: "Xóa dòng",
    datLaiSoLieuGoc: "Đặt lại theo số liệu gốc",
    goiYSua: "Bấm vào ô để sửa. Số liệu trên hệ thống không đổi — đây chỉ là bản để in.",
    daSuaTay:
      "Bản in này đã sửa tay {n} chỗ so với số liệu hệ thống. Bản sửa chỉ lưu trong trình duyệt này (theo tàu, bộ phận, tháng); bấm \"Đặt lại theo số liệu gốc\" để bỏ.",
    xacNhanDatLai: "Bỏ mọi chỗ đã sửa tay và quay về số liệu gốc của hệ thống?",
    bpMay: "MÁY",
    bpBoong: "BOONG",
  ...
  },
  {
    ...
    xongSua: "Done editing",
    themDongBaoCao: "Add line",
    xoaDongBaoCao: "Delete line",
    datLaiSoLieuGoc: "Reset to system data",
    goiYSua: "Click a cell to edit. System data is not changed — this is only the print copy.",
    daSuaTay:
      "This print copy has {n} manual edits compared with the system data. Edits are kept only in this browser (per vessel, department, month); click \"Reset to system data\" to discard.",
    xacNhanDatLai: "Discard all manual edits and return to the system data?",
    bpMay: "ENGINE",
    bpBoong: "DECK",
