...
export default function PhieuGiaoDuyet({
  ...
  const capNhat = (i: number, patch: Partial<DongHienThi>) =>
    setDong((ds) => ds.map((d, j) => (j === i ? { ...d, ...patch } : d)));
  const themDong = () =>
    setDong((ds) => [
      ...ds,
      { chon: true, ten: "", partNo: "", impa: "", soLuong: "1", donVi: "PCS", loai: "SPARE", thietBi: "", materialId: null, materialLabel: null },
    ]);
    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 gap-4 xl:grid-cols-[minmax(0,3fr)_minmax(0,2fr)]">
        ...
        <div className="space-y-3">
          ...
          <iframe src={duongDanTep} title={phieu.fileName} className="h-[70vh] w-full rounded-xl border border-[var(--border-subtle)] bg-white" />
          {phieu.chuDoc && (
